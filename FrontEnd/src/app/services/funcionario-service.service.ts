...
export class FuncionarioService {
  ...
  AlterarStatusFuncionario(id: number, ativo: boolean): Observable<any> {
    return this.http.put<Response<Funcionario[]>>(`${this.apiUrl}/AlteraStatusFuncionario/${id}/${ativo}`, null);
}
